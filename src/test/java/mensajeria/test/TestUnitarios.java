...
public class TestUnitarios {
    ...
    public void test_insertarEmpresa_enBD_comparacionTamaniosTrasLectura() {
        try {
            ...
            instance.conectar();
            instance.db.getCollection("Empresa").deleteOne(new Document("nombre_empresa", "test_empresa_thJkl980HAsse78V"));
   ...
   @Test
    ...
    public void test_eliminarEmpresa_borradoLogico_primerElemento(){
        ...
        try {
            ...
            String id_empresa = instance.getListaEmpresas().get(0).getId_empresa();
            ...
            instance.conectar();
            instance.db.getCollection("Empresa").deleteOne(new Document("nombre_empresa", "test_empresa_thJkl980HAsse78V"));
            instance.db.getCollection("Empresa").updateOne(new Document("_id", id_empresa), new Document("$set", new Document("activo", true)));
            instance.desconectar();  
