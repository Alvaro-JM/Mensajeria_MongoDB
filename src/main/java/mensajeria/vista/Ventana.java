...
public class Ventana extends javax.swing.JFrame {
    ...
    private void jButton_empresa_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_empresa_borrarActionPerformed
        Empresa empresa = listaEmpresasMostradas.get(filaEmpresa);
        String id_empresaEliminar = empresa.getId_empresa();
    ...
    private void jTable_oficinaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_oficinaMouseClicked
        ...
        String empresa = oficina.getEmpresa();
        int index = 0;
    ...
    private void jButton_oficina_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_borrarActionPerformed
        Oficina oficina = listaOficinasMostradas.get(filaOficina);
        String id_oficinaEliminar = oficina.getId_oficina();
    ...
    private void jButton_oficina_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_oficina_guardarActionPerformed
        ...
        if (direccion_oficina.equals("") || telefono_oficina.equals("") || email.equals("") || encargado.equals("")) {
            ...
            try {
                ...
                String empresa = listaEmpresasMostradas.get(empresaSeleccionada).getId_empresa();
    ...
    private void jTable_repartidorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_repartidorMouseClicked
        ...
        String oficina = repartidor.getOficina();
        int index = 0;
    ...
    private void jButton_repartidor_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_repartidor_borrarActionPerformed
        Repartidor repartidor = listaRepartidoresMostrados.get(filaRepartidor);
        String id_repartidorEliminar = repartidor.getId_repartidor();
        ...
        if (dni.equals("") || nombre_repartidor.equals("") || telefono_repartidor.equals("") || jTextField_repartidor_antiguedad.getText().equals("")) {
            ...
            try {
                ...
                if (antiguedad < 0) {
                    ...
                    String oficina = listaOficinasMostradas.get(oficina_seleccionada).getId_oficina();
    ...
    private void jTable_paqueteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_paqueteMouseClicked
        ...
        String repartidor = paquete.getRepartidor();
        int index = 0;
    ...
    private void jButton_paquete_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_paquete_borrarActionPerformed
        Paquete paquete = listaPaquetesMostrados.get(filaPaquete);
        String id_paqueteEliminar = paquete.getId_paquete();
    ...
    private void jButton_paquete_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_paquete_guardarActionPerformed
        ...
        if (direccion_destino.equals("") || telefono_destino.equals("") || direccion_origen.equals("") || telefono_origen.equals("")) {
            ...
            try {
                ...
                String repartidor = listaRepartidoresMostrados.get(repartidor_seleccionado).getId_repartidor();
    ...
    private boolean datosAsociadosEmpresa(String id_empresa){
        ...
        while (it_oficina.hasNext() && datosAsociados == false) {
            ...
            if (o.getEmpresa().equals(id_empresa)) {
                datosAsociados = true;
            }
        }
    ...
    private boolean datosAsociadosOficina(String id_oficina){
        boolean datosAsociados = false;
        ...
        while (it_repartidor.hasNext() && datosAsociados == false) {
            ...
            if (r.getOficina().equals(id_oficina)) {
                datosAsociados = true;
            }
        }
        return datosAsociados;
    ...
    private boolean datosAsociadosRepartidor(String id_repartidor){
        boolean datosAsociados = false;
        ...
        while (it_paquete.hasNext() && datosAsociados == false) {
            ...
            if (p.getRepartidor().equals(id_repartidor)) {
                datosAsociados = true;
            }
        }
        return datosAsociados;
    ...
    private boolean datosUnicosEmpresas(String nombre_empresa, String cif, String web){
        ...
        if (aniadirEmpresa) {
            ...
            String id_empresa = listaEmpresasMostradas.get(filaEmpresa).getId_empresa();
            while (it.hasNext() && datosUnicos) {
                Empresa empresa = it.next();
                if (!empresa.getId_empresa().equals(id_empresa)) {
                    if (nombre_empresa.equals(empresa.getNombre_empresa())) {
                        datosUnicos = false;
                    }
                    if (cif.equals(empresa.getCif())) {
    ...
    private boolean datosUnicosOficinas(String direccion_oficina, String telefono_oficina, String email){
        ...
        if (aniadirOficina) {
            ...
            String id_oficina = listaOficinasMostradas.get(filaOficina).getId_oficina();
            while (it.hasNext() && datosUnicos) {
                Oficina oficina = it.next();
                if (!oficina.getId_oficina().equals(id_oficina)) {
                    if (direccion_oficina.equals(oficina.getDireccion_oficina())) {
                        datosUnicos = false;
                    }
                    if (telefono_oficina.equals(oficina.getTelefono_oficina())) {
    ...
    private boolean datosUnicosRepartidores(String dni, String telefono_repartidor){
        ...
        if (aniadirRepartidor) {
            ...
            String id_repartidor = listaRepartidoresMostrados.get(filaRepartidor).getId_repartidor();
            while (it.hasNext() && datosUnicos) {
                Repartidor repartidor = it.next();
                if (!repartidor.getId_repartidor().equals(id_repartidor)) {
                    if (dni.equals(repartidor.getDni())) {
                        datosUnicos = false;
                    }
                    if (telefono_repartidor.equals(repartidor.getTelefono_repartidor())) {
    ...
    public void modificarEmpresa(int filaSeleccionada, String nombre_empresa, String cif, String director, String web){
        String id_empresa = listaEmpresasMostradas.get(filaSeleccionada).getId_empresa();
        empresaControlador.modificarEmpresa(id_empresa, nombre_empresa, cif, director, web);
    }
    
    public void eliminarEmpresa(String id_empresaEliminar){
    ...
    private void aniadirOficina(String direccion_oficina, String telefono_oficina, String email, String encargado, String empresa){
        oficinaControlador.insertarOficina(direccion_oficina, telefono_oficina, email, encargado, empresa);
    }
    
    private void modificarOficina(int filaSeleccionada, String direccion_oficina, String telefono_oficina, String email, String encargado, String empresa){
        String id_oficina = listaOficinasMostradas.get(filaSeleccionada).getId_oficina();
        oficinaControlador.modificarOficina(id_oficina, direccion_oficina, telefono_oficina, email, encargado, empresa);
    }
    
    private void eliminarOficina(String id_oficinaEliminar){
    ...
    private void aniadirRepartidor(String dni, String nombre_repartidor, String telefono_repartidor, int antiguedad, String oficina){
        repartidorControlador.insertarRepartidor(dni, nombre_repartidor, telefono_repartidor, antiguedad, oficina);
    }
    
    private void modificarRepartidor(int filaSeleccionada, String dni, String nombre_repartidor, String telefono_repartidor, int antiguedad, String oficina){
        String id_repartidor = listaRepartidoresMostrados.get(filaSeleccionada).getId_repartidor();
        repartidorControlador.modificarRepartidor(id_repartidor, dni, nombre_repartidor, telefono_repartidor, antiguedad, oficina);
    }
                
    private void eliminarRepartidor(String id_repartidorEliminar){
    ...
    private void aniadirPaquete(Date fecha_entrega, String direccion_destino, String telefono_destino, String direccion_origen, String telefono_origen, String repartidor){
    ...
    private void modificarPaquete(int filaSeleccionada, Date fecha_entrega, String direccion_destino, String telefono_destino, String direccion_origen, String telefono_origen, String repartidor){
        String id_paquete = listaPaquetesMostrados.get(filaSeleccionada).getId_paquete();
    ...
    private void eliminarPaquete(String id_paqueteEliminar){
